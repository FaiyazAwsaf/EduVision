...
export async function createRubricSet(
  ...
  const response = await fetch(`${API_URL}/rubric-sets/`, {
    method: "POST",
    headers: {
...
export async function updateRubricSet(
  ...
  const response = await fetch(`${API_URL}/rubric-sets/${id}/`, {
    method: "PUT",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function publishRubricSet(id: string): Promise<RubricSet> {
  const response = await fetch(`${API_URL}/rubric-sets/${id}/publish/`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function testRubricSet(
  ...
  const response = await fetch(`${API_URL}/rubric-sets/test/`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function listRubricSets(filters?: {
  ...
  const url = `${API_URL}/rubric-sets/${params.toString() ? "?" + params.toString() : ""}`;
...
export async function archiveRubricSet(id: string): Promise<RubricSet> {
  const response = await fetch(`${API_URL}/rubric-sets/${id}/archive/`, {
    method: "POST",
    headers: {
      "Content-Type": "application/json",
    },
...
export async function getRubricSetVersions(id: string): Promise<any[]> {
  const response = await fetch(`${API_URL}/rubric-sets/${id}/versions/`);
