/**
 * AI Content Request System - Phase 2 Frontend
 *
 * Main page that orchestrates the content request workflow:
 * 1. User submits request via form
 * 2. System polls for status updates
 * 3. Displays generated content when ready
 *
 * State management is intentionally simple (local state).
 * Authentication and WebSocket support will be added in Phase 3.
 */
