  ...
  return (
    <div className="bg-white rounded-xl border border-secondary p-6">
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              disabled={disabled}
              className="w-full px-4 py-2.5 border border-secondary rounded-lg focus:ring-2 focus:ring-primary focus:border-primary bg-white text-primary-dark disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
            >
            ...
            <div>
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-4 py-2.5 border border-secondary rounded-lg focus:ring-2 focus:ring-primary focus:border-primary bg-white text-primary-dark placeholder-secondary disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
                />
                <button
                  type="button"
                  onClick={addKeyword}
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  {((rule.config as KeywordConfig).required_keywords || []).map(
                    (keyword, index) => (
                      <span
                        key={index}
                        className="inline-flex items-center gap-1 px-3 py-1 bg-primary/10 text-primary-dark rounded-full text-sm"
                      >
                        {keyword}
                        <button
                          type="button"
                          ...
                          disabled={disabled}
                          className="hover:text-primary-dark disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <svg
                            className="w-4 h-4"
                            fill="none"
        ...
        {rule.type === "numeric" && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-t border-secondary pt-4">
            <div>
              <label className="block text-sm font-medium text-primary-dark mb-1">
                Expected Value
              </label>
          ...
          <div className="space-y-4 border-t border-secondary pt-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 border border-secondary rounded-lg focus:ring-2 focus:ring-primary focus:border-primary bg-white text-primary-dark placeholder-secondary disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
              />
            </div>
            ...
            <div>
              <label className="flex items-center gap-2">
                <input
                  ...
                  disabled={disabled}
                  className="rounded border-secondary text-primary focus:ring-primary disabled:opacity-60 disabled:cursor-not-allowed"
                />
