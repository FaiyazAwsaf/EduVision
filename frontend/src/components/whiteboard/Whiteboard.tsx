  ...
  async (imageData: string, bounds: SelectionBounds) => {
    ...
    try {
      ...
      if (result.success && result.latex) {
        ...
        // Remove handwritten strokes from canvas (optional)
        // You can implement this by tracking which paths are in the selected region
        ...
        console.log('[Whiteboard] LaTeX conversion successful:', result.latex);
      } else {
